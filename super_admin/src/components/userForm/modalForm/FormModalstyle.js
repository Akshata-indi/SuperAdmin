const modalStyles = {
    ...
    style2: {
      ...
      container: 'bg-white rounded-sm text-sm w-[36%] h-full font-normal  shadow-sm relative  ',
      ...
      cancel:'px-6 py-2 text-black  bg-white rounded-md border-2 hover:bg-gray-300 fixed bottom-0 right-4 mb-10 mr-40'
    },
