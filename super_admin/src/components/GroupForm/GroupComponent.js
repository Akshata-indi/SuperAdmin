        ...
        <div className='basis-[100%]'>
            <div className='main-container pt-10'>
                ...
                <div className='btn-container flex justify-between px-40'>
                    <h3 className="text-xl font-sans text-gray-600">2 Groups</h3>
            ...
            <div className='sidebar-and-content-container flex px-40 py-10'>
                ...
                {/* Sidebar */}
                <div className="w-1/4 bg-white-200 border-2 border-gray-100 rounded-l-lg p-4 shadow-sm bg-zinc-50" style={{ height: '70vh' }}>
                    <Sidebar menuConfigs={groupmenuData} />
                </div>

                {/* Main content */}
                <div className="w-3/4 bg-white-200 border-y-2 border-r-2 border-gray-100 rounded-r-lg p-4 shadow-sm bg-zinc-50" style={{ height: '70vh' }}>
