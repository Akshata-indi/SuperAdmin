const InputStyle = {
    ...
    standard: 'border-b-2 border-gray-200 bg-transparent text-gray my-4 mx-4 py-2 px-2 leading-tight focus:outline-none ',
...
<<<<<<< HEAD
    ...
    boxInput1: 'w-[90%] my-4 mx-8 px-6 py-2 rounded-[7px] border-b-2 border-gray-400  text-sm font-normal  outline-0     focus:border-2    ',
     
}
=======
>>>>>>> 483c72eb65e2604b1db4fb2e46cb120aca162a69
    ...
    //     overlayBackground: ' fixed inset-0 bg-black opacity-40',
    //     container: ' bg-white rounded-sm text-sm w-[42%] h-full font-bold  shadow-sm relative  ',
